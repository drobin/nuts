...
* Update `openssl` from 0.10.71 to 0.10.72 to fix Dependabot alert
...
* Update `openssl` from 0.10.64 to 0.10.66 to fix Dependabot alert
...
[0.7.9]: https://github.com/drobin/nuts/tree/v0.7.9
